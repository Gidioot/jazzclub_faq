        ...
        <main>
            ...
            {/*<Accordion alwaysOpen className={"tw-max-w-3xl tw-mx-auto"}>*/}
                ...
                <Accordion.Item eventKey={"6"}>
                    ...
                    <Accordion.Body>
                        <Image src={'/Jazzclub I Poster.png'} width={500} height={500} alt={"Poster of Jazzclub I: Jazztronomical"} className={"tw-object-contain tw-max-w-md tw-h-full tw-w-full"}></Image>
                        <br />Download it <Link href={""} onClick={saveFile}>here</Link>!
                    </Accordion.Body>
                </Accordion.Item>
                <Accordion.Item eventKey={"7"}>
                    <Accordion.Header>And if I want to view that poster in real life?</Accordion.Header>
                    <Accordion.Body>
                        Walk around Delft, the campus of TU Delft or past the Bierfabriek!
                    </Accordion.Body>
                </Accordion.Item>
                ...
                <Accordion.Item eventKey={"10"}>
                    <Accordion.Header>How many nights of sleep is it until Jazzclub I: Jazztronomical?</Accordion.Header>
                    <Accordion.Body>
                        18!*<br/>
                        <p className={"tw-text-sm"}><br/>*This information may be incorrect.</p>
                    </Accordion.Body>
                </Accordion.Item>
                ...
                <Accordion.Item eventKey={"15"}>
                    ...
                    <Accordion.Body>
                        No crazy, he&apos;s already back to Spain. Act normal.
                    </Accordion.Body>
                </Accordion.Item>
                <Accordion.Item eventKey={"16"}>
                    <Accordion.Header>Has Bram been wallpaper glued?</Accordion.Header>
                    <Accordion.Body>
                        <Image src={'/behanglijm.jpg'} width={500} height={500} alt={"Wallpaper glue inside a pannier"} className={"tw-object-contain tw-max-w-md tw-h-full tw-w-full"}></Image>
                    </Accordion.Body>
                </Accordion.Item>
            </Accordion>
        </main>
